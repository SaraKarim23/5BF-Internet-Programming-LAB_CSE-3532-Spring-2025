   ...
   <div class="container"> 
     <div class="row">
        ...
        <div class="page-header">
            <h1 style="text-align: center;">New Service Form </h1>
            <?php echo $msg; ?>
      </div> 
       <div class="col-md-3">
        ...
        <div class="col-md-6 animated bounceIn"> 
            ...
            <form class="form-horizontal" action="" method="post" enctype="multipart/form-data">
                ...
                <br> 
                 ...
                 <div class="input-group">
                  <span class="input-group-addon"><b>Service No</b></span>
                  <input id="vehchesis" type="text" class="form-control" name="vehchesis" placeholder="Service No">
                </div>
                <br> 
