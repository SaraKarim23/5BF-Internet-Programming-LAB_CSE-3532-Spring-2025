    ...
    <div class="container">
        <div class="row">
            <div class="page-header">
                <h1 style="text-align:center;">Servicing Form</h1>
                 <?php //echo $msg; ?>
            </div>
            ...
            <div class="col-md-6">
                <form class="animated bounce" action="bookingaction.php" method="post">
                    ...
                    <br>
                    <div class="input-group">
                      <span class="input-group-addon"><b>Service type</b></span>
                      <input id="department" type="text" class="form-control" name="department" placeholder="type" required>
                    </div>
                    <br>
                    <div class="input-group">
                    ...
                    <div class="input-group">
                      ...
                      <input id="req_date" type="text" class="form-control" name="req_date" placeholder="Day the service is needed" required>
                    ...
                    <div class="input-group">
                      ...
                      <input id="return_date" type="text" class="form-control" name="return_date" placeholder="Day the vehicle is returned" required>
                    ...
                    <div class="input-group">
                      ...
                      <input id="destination" type="text" class="form-control" name="destination" placeholder="Service Destination" required>
                    </div>
                    <br>
                    ...
                    <div class="input-group">
                      <span class="input-group-addon"><b>Reason for servicing</b></span>
                      <input id="reason" type="text" class="form-control" name="reason" placeholder="Reason of servicing the vehicle">
                    </div>
                    <br>
